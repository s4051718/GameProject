...
public class game {
    ...
    public static void adventureStart() {
        ...
        System.out.println(
                "The evil Lich King in the Ice Castle atop the Misty Mountains has cast his evil shadow over the land for too long.");
        if (game.pCharacter.getCharType().equals("Warrior")) {
            ...
            System.out
                    .println("But before you begin your quest you must speak to the Guildmaster in the Thieves Guild.");
